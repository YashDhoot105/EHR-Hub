...
const DoctorHomePage = () => {
  ...
  <button type="submit" class="view_appointments_button p-2"><i class="fas fa-calendar-alt" style={{paddingRight: "5px",paddingLeft: "5px"}}></i> View Appointments <i class="fas fa-arrow-right" style={{paddingRight: "5px",paddingLeft: "5px"}} ></i></button>
